...
def validate_scanner_inputs(
    ...
    for field in ("generated_at", "target", "reported_runtime", "safety", "coverage", "counts", "blind_spots", "skill_surface_evidence"):
...
def merge_inventory(
    ...
    original_skill_surface_evidence = copy.deepcopy(inventory.get("skill_surface_evidence"))
    original_hashes = {
    ...
    if enriched.get("skill_surface_evidence") != original_skill_surface_evidence:
        raise PacketError("internal error: merge altered scanner skill surface evidence")
    enriched_hashes = {
