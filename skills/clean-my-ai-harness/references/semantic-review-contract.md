...
If the scanner received validated cross-harness skill evidence, the model treats that object as frozen scanner evidence. It does not edit provider identities, origin kinds, configured/exposed states, or symlink targets in the semantic review.
